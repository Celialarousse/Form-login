...
<html lang="en">
    ...
    <body>
        ...
        <!-- HERO -->
        <section class="hero">
            <h1>Bienvenue,<br><span><?php echo isset($_SESSION['user_prenom']) ? htmlspecialchars($_SESSION['user_prenom']) : 'Rider'; ?></span></h1>
            ...
            <div class="cards-grid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="card-link">Voir les fiches →</a>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="card-link">Découvrir →</a>
                    </div>
                </div>
